...
To achieve this, \ac{YCSB} uses a Zipfian generator which is based on the one proposed by Jim Gray \cite{QuicklyGeneratingBillionrecord}. One limiting factor on his original paper is that it's the generated keys are lexographically sorted,
...
\begin{enumerate}
  \item Generate a zipfian variate using the algorithm proposed by Jim Gray \cite{QuicklyGeneratingBillionrecord}
